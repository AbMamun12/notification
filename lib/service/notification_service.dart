...
class NotificationService {
  ...
  ///Handel message when the app is in the background or terminated
  ...
  static Future<void> initializeNotification() async {
    ...
    FirebaseMessaging.onMessageOpenedApp.listen((RemoteMessage message) {
      print("App opened from background notification: ${message.data}"); // Don't invoke 'print' in production code.
    });
  ...
  static Future<void> _getFcmToken() async {
    ...
    print('FCM Token: $token'); // Don't invoke 'print' in production code. Try using a logging framework.
